...
function Training(){
  ...
  <h2 className="font-weight-light text-center">Преимущества обучения и торговли в нашей проп-компании.</h2>
          ...
          <img 
            ...
            <h3 className="text-center">Большое комьюнити трейдеров</h3>
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <small className="text-muted">9 минут</small>
              </div>
            </div>
          </div>
        </div>
  ...
  <h1 className="display-4">Ценообразование</h1>
  <p className="lead">С помощью этого примера Bootstrap быстро создайте эффективную таблицу цен для ваших потенциальных клиентов. Он построен с использованием компонентов и утилит Bootstrap по умолчанию с небольшой настройкой.</p>
</div>
  ...
  <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
    <div className="col">
      ...
      <div className="card-header">
        <h4 className="my-0 font-weight-normal">Бесплатно</h4>
      </div>
      <div className="card-body">
        <h1 className="card-title pricing-card-title">$0 <small className="text-muted">/ мес.</small></h1>
        ...
        <button type="button" className="btn btn-lg btn-block btn-outline-primary">Подпишитесь бесплатно</button>
      </div>
    </div>
    </div>
    <div className="col">
      ...
      <div className="card-body">
        <h1 className="card-title pricing-card-title">$15 <small className="text-muted">/ мес.</small></h1>
        <ul className="list-unstyled mt-3 mb-4">
        ...
        <button type="button" className="btn btn-lg btn-block btn-primary">Начать</button>
      </div>
    </div>
    </div>
    <div className="col">
      ...
      <div className="card-body">
        <h1 className="card-title pricing-card-title">$29 <small className="text-muted">/ мес.</small></h1>
        <ul className="list-unstyled mt-3 mb-4">
        ...
        <button type="button" className="btn btn-lg btn-block btn-primary">Связаться с нами</button>
      </div>
    </div>
    </div>
  </div>
